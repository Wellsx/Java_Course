...
public class CollectionsDemo {
    ...
    public static void setDemo(){
        // <> operator declare data type within collection
        ...
        //iterator() and while hasNext returns true until it runs out of items
    ...
    public static void mapDemo(){
        //<> operator cant declare primitive data type use wrapper class
...
*/
        for (var entry: fruitCalories.entrySet()){
            //getValue requires declaring data type of map key and value
